...
const DialogContent = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Content>, DialogContentProps>(({ className, children, hiddenClose = false, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
